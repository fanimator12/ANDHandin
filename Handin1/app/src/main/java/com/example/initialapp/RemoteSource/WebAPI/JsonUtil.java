...
public class JsonUtil {
    ...
    public static Type getListTypeForDeserialization(Class cls) {
        ...
        if ("Auth".equalsIgnoreCase(className)) {
            return new TypeToken<List<Auth>>() {
            }.getType();
        }

        if ("Bucketlist".equalsIgnoreCase(className)) {
            return new TypeToken<List<Bucketlist>>() {
            }.getType();
        }
        ...
        if ("Reset".equalsIgnoreCase(className)) {
            return new TypeToken<List<Reset>>() {
            }.getType();
        }
    ...
    public static Type getTypeForDeserialization(Class cls) {
        ...
        if ("Auth".equalsIgnoreCase(className)) {
            return new TypeToken<Auth>() {
            }.getType();
        }

        if ("Bucketlist".equalsIgnoreCase(className)) {
            return new TypeToken<Bucketlist>() {
            }.getType();
        }

        if ("Item".equalsIgnoreCase(className)) {
            return new TypeToken<Item>() {
            }.getType();
        }

        if ("Reset".equalsIgnoreCase(className)) {
            return new TypeToken<Reset>() {
            }.getType();
        }
